...
p1 + 
  geom_point(data = set_10, color = brewer.pal(4, "Dark2")[1], alpla = 0.4) +
  geom_point(data = set_20, color = brewer.pal(4, "Dark2")[2], alpha = 0.6) +
  geom_point(data = set_50, color = brewer.pal(4, "Dark2")[3], alpha = 0.8) +
  geom_point(data = set_na, color = brewer.pal(4, "Dark2")[4]) +
